...
function CtaEnvelope() {
  ...
  return <CircleButton type="primary" className="w-[60px] h-[60px]" text={<img alt="digital envelope" src="/images/donate.svg" width={36} height={36} />} onClick={() => showModal(<ModalEnvelope />, 'Amplop Digital')} />
}
