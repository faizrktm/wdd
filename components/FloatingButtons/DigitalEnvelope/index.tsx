  ...
  return (
    <ModalProvider>
      <div className="relative flex items-center">
        <div id="tooltip-left" role="tooltip" className={`flex relative transition-opacity ease-in-out duration-1000 items-center max-w-[230px] z-10 py-2 px-3 mr-3 text-xs text-white bg-primary rounded-lg shadow-lg opacity-${showTooltip} tooltip`}>
          <p>Sekarang <b>amplopmu</b> bisa tersampaikan secara digital 🥰</p>
