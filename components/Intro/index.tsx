...
export default function Intro({ onChange }: IntroProps){
  return (
    <div className="flex flex-col bg-wheat h-screen w-screen place-items-center">
      <div className="bg-white text-center w-5/6 rounded-lg p-8 md:p-16 bg-opacity-80 m-auto">
        ...
        <h1 className="main-text text-4xl md:text-7xl lg:text-8xl text-wheat mb-2.5">Faiz &amp; Rara</h1>
