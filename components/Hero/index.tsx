...
export default function Hero(){
  return (
    <div className="flex flex-col bg-primary w-screen h-[80vh] place-items-center bg-[url('/images/bg2-new.jpg')] lg:bg-[url('/images/bg.jpg')] bg-cover bg-no-repeat bg-center">
