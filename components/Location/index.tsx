  ...
  return (
    <Section className="bg-white">
      <div className="bg-primary text-center w-5/6 rounded-lg p-8 bg-opacity-80 m-auto">
        ...
        <Link location="https://goo.gl/maps/fULf5scf6HcDCd2a7" text="Buka Peta" className="mt-4" icon={<div className="mr-2"><Image src="/images/google-maps.webp" alt="icon map" width={20} height={20} /></div>} />
      </div>
    </Section>
  )
}
